...
<div class="main-columns container space-20">
  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <div id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content" class="space-padding-0"><?php echo $content_top; ?>
      ...
      <h3 style="display:none" class="heading-left"><?php echo $text_location; ?></h3>
        ...
        <div class="row">
            ...
            <fieldset class="col-md-8">
                ...
                <div class="form-group required">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="name" value="<?php echo $name; ?>" id="input-name" class="form-control" style="border: 1px solid grey" />
                        <?php if ($error_name) { ?>
                ...
                <div class="form-group required">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="email" value="<?php echo $email; ?>" id="input-email" class="form-control" style="border: 1px solid grey"/>
                        <?php if ($error_email) { ?>
                ...
                <div class="form-group required">
                    ...
                    <div class="col-sm-9">
                        <textarea name="enquiry" rows="10" id="input-enquiry" class="form-control" style="border: 1px solid grey" ><?php echo $enquiry; ?></textarea>
                ...
                <div class="buttons">
                    <div class="pull-right">
                        <input class="btn btn-default" type="submit" value="<?php echo $button_submit; ?>" style="border: 2px solid grey"/>
                    </div>
                </div>
            </fieldset>

            <fieldset class="col-md-4">
                   <h3 class="heading-left"><?php echo $heading_title; ?></h3>
                            ...
                            <div class="panel-body">
                              <div class="row">
                                ...
                                <?php } ?>
                                    ...
                                    <div class="media">
                                      <div class="media-icon pull-left"><img src="catalog/view/theme/pav_ministore/template/information/mobile.png"> </span></div>
                                      <div class="media-body">
                                          <p style="direction:ltr; display:inline-block"><?php echo $telephone; ?><br /></p>
                                            <br />
                                  ...
                                  <div class="media" style="padding-left: 15px;">
                                      ...
                                      <div class="media-body">
                                          ...
                                          <a href="https://www.facebook.com/OgawaWorldQatar/" class="fa fa-facebook" target="_blank"></a>
                                          <a href="https://www.instagram.com/ogawaqatar/" class="fa fa-instagram" target="_blank"></a>
                                      </div>
                                  </div>
