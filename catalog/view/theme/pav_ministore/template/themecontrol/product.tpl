    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="product-info">
        <div class="row">
          ...
          <?php require( ThemeControlHelper::getLayoutPath( 'product/preview/custom_quickview.tpl' ) );  ?>
          ...
          <ul class="list-unstyled">
            ...
            <div id="product">
                    ...
                    <div id="input-option<?php echo $option['product_option_id']; ?>">
                        ...
                        <form id="myForm">
                            ...
                            <div class="radio"  style="display: inline">
                                ...
                                <input id="<?php echo $id++; ?>" type="radio" hidden checked about="<?php echo $option_value['name']; ?>"  name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" />
                                <?php } else { ?>
                                <input id="<?php echo $id++; ?>" type="radio"  hidden about="<?php echo $option_value['name']; ?>" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" />
                                <?php } ?>
              ...
              <?php } ?>
               ...
               <div class="product-buttons-wrap wrap-quick">
                  <div class="product-qyt-action space-padding-b-45 clearfix border-bottom">
                      <div class="quantity-title qty"><?php echo $entry_qty; ?>:</div>
                  ...
                  <div class="pull-left space-right-15">
                      ...
                      <button <?php if($quantity <= 0 ) echo "disabled"; ?>  type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary">
                  ...
                  <div class="pull-left space-right-15">
                   ...
                   <div class="pull-left">
                       <a href="<?php echo $download_link; ?>" data-toggle="tooltip" class="btn btn-sm btn-inverse-light" title="<?php echo $text_download; ?>" ><i class="zmdi zmdi-cloud-download zmdi-hc-fw"></i></a>
                   </div>
                   <?php } ?>
