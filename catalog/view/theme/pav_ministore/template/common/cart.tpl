  ...
  <ul class="dropdown-menu pull-right">
    ...
    <li>
      <div>
        ...
        <p class="text-right"><a href="<?php echo $cart; ?>"><span class="btn btn-primary"><?php echo $text_cart; ?></span></a><a style="display: none;"  href="<?php echo $checkout; ?>"><span class="btn btn-default"><?php echo $text_checkout; ?></span></a></p>
      </div>
    </li>
    <?php } else { ?>
    <li>
