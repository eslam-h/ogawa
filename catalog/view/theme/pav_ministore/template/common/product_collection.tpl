...
<div id="products" class="product-<?php echo $DISPLAY_MODE; ?>"> 
    <div class="products-block ">
        ...
        ?>
        <div class="col-lg-<?php echo $span;?> col-md-<?php echo $span;?> col-sm-<?php echo $small;?> col-xs-<?php echo $mini;?> product-col">           
            
            <?php require( ThemeControlHelper::getLayoutPath( 'common/product/new_default.tpl' ) );  ?>
        </div>
