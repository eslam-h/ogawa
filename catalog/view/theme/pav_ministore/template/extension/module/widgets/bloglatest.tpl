...
?>
<?php if( !empty($blogs) ) { ?>
<div id="blog-carousel" class="widget-blogs panel-center latest-posts latest-posts-v1 panel panel-default <?php echo $addition_cls;?> <?php $addition_cls?> <?php if ( isset($stylecls)&&$stylecls) { ?>box-<?php echo $stylecls; ?><?php } ?>">
	<?php if( $show_title ) { ?>
										...
										<div class="latest-posts-meta media-body">
											<div class="bottom-blog">
												...
												<div class="shortinfo">
													...
													<?php echo utf8_substr( $blog['description'],0, 15 );?> ...
												</div>
