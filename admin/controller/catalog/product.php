	...
	protected function getForm() {
        ...
        foreach ($product_features as $product_feature) {
            ...
            $data['product_features'][] = array(
                ...
                'thumb'                         => $this->model_tool_image->resize($product_feature['image'], 100, 100),
                'image'                         => $product_feature['image'],
                'sort_order'                         => $product_feature['sort_order'],
                'product_feature_description'   => $product_feature['product_feature_description'],
                'product_feature_title'   => $product_feature['product_feature_title']
            );
        }
