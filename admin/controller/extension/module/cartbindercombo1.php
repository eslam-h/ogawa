...
class ControllerExtensionModuleCartbindercombo1 extends Controller {
	...
	private function getForm() {
		...
		if (isset($this->request->post['name'])) {
			...
			$data['name'] = $this->model_tool_cartbindercombo1->getcartbindercombo1Description($this->request->get['id']);//array($this->config->get('config_language_id') => $cartbindercombo1_info['name']);
		} else {
			$data['name'] = '';
		}
