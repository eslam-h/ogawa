...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/stores')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_stores'),
                    'href'     => $this->url->link('catalog/stores', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'catalog/gallerycategory')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_gallery_category'),
                    'href'     => $this->url->link('catalog/gallerycategory', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'catalog/emailverification')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_email_verification'),
                    'href'     => $this->url->link('catalog/emailverification', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'catalog/customvoucher')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_custom_voucher'),
                    'href'     => $this->url->link('catalog/customvoucher', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
