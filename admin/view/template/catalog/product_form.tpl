      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <!-- Momen Code-->
            <li><a href="#tab-feature" data-toggle="tab"><?php echo $tab_feature; ?></a></li>
            <!-- End Momen Code-->
            ...
            <div class="tab-pane" id="tab-feature">
              <div class="table-responsive">
                <table id="feature" class="table table-striped table-bordered table-hover">
                  ...
                  <tr id="feature-row<?php echo $feature_row; ?>">

                    <!--
                    <td class="text-left" style="width: 40%;">
                      <input type="text" name="product_feature[<?php echo $feature_row; ?>][name]" value="<?php echo $product_feature['name']; ?>" placeholder="<?php echo $entry_feature; ?>" class="form-control" />
                      <input type="hidden" name="product_features[<?php echo $features_row; ?>][features_id]" value="<?php echo $product_features['features_id']; ?>" />
                    </td>
                    -->
                    <td class="text-left">
                      <input type="text" name="product_feature[<?php echo $feature_row; ?>][sort_order]" value="<?php echo $product_feature['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" />
                    </td>
                    <td class="text-center">
                      <a href="" id="thumb-feature-image<?php echo $feature_row; ?>" data-toggle="image" class="img-thumbnail">
                        <img src="<?php echo $product_feature['thumb']; ?>" alt="Enter Image" title=""  />
                      </a>
                      <input type="hidden" name="product_feature[<?php echo $feature_row; ?>][image]" value="<?php echo $product_feature['image']; ?>" id="input-feature-image<?php echo $feature_row; ?>" />
                      <input type="hidden" name="product_feature[<?php echo $feature_row; ?>][feature_id]" value="<?php echo $product_feature['feature_id']; ?>" />
                    </td>
                    ...
                    <td class="text-left"><?php foreach ($languages as $language) { ?>
                      <div class="input-group">
                        ...
                        <input type="text" name="product_feature[<?php echo $feature_row; ?>][product_feature_description][<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($product_feature['product_feature_title'][$language['language_id']]) ? $product_feature['product_feature_title'][$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control">

                        <textarea name="product_feature[<?php echo $feature_row; ?>][product_feature_description][<?php echo $language['language_id']; ?>][text]" rows="5" placeholder="<?php echo $entry_text; ?>" class="form-control">
                          <?php echo isset($product_feature['product_feature_description'][$language['language_id']]) ? $product_feature['product_feature_description'][$language['language_id']]['text'] : ''; ?>
                        </textarea>
                      </div>
                      <?php } ?>
                    </td>
                    <td class="text-left">
                      <button type="button" onclick="$('#feature-row<?php echo $feature_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
                    </td>
                  </tr>
                  <?php $feature_row++; ?>
                  <?php } ?>
                  ...
                  <tr>
                    <td colspan="3"></td>
                    <td class="text-left">
                      <button type="button" onclick="addFeature();" data-toggle="tooltip" title="<?php echo $button_feature_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button>
                    </td>
                  </tr>
                  </tfoot>
                </table>
...
function addAttribute() {
    ...
    function addFeature() {
      html  = '<tr id="feature-row' + feature_row + '">';


      html += '<td class="text-left"> <input type="text" name="product_feature[' + feature_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /> </td>'

      html += '  <td class="text-center"><a href="" id="thumb-feature-image' + feature_row + '"data-toggle="image" class="img-thumbnail"><img src="" alt="Enter Image" title=""  /></a><input type="hidden" name="product_feature[' + feature_row + '][image]" value="" id="input-feature-image' + feature_row + '" /></td>';
      //html += '  <td class="text-left" style="width: 20%;"><input type="text" name="product_attribute[' + attribute_row + '][name]" value="" placeholder="<?php echo $entry_attribute; ?>" class="form-control" /><input type="hidden" name="product_attribute[' + attribute_row + '][attribute_id]" value="" /></td>';


      html += '  <td class="text-left">';
    <?php foreach ($languages as $language) { ?>
        html += '<div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span> <input type="text" name="product_feature['+ feature_row +'][product_feature_description][<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($product_feature['product_feature_title'][$language['language_id']]) ? $product_feature['product_feature_title'][$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control"> <textarea name="product_feature[' + feature_row + '][product_feature_description][<?php echo $language['language_id']; ?>][text]" rows="5" placeholder="<?php echo $entry_text; ?>" class="form-control"></textarea></div>';
      <?php } ?>
      html += '  </td>';
      ...
      html += '  <td class="text-left"><button type="button" onclick="$(\'#feature-row' + feature_row + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
      html += '</tr>';
