            ...
            <input type="hidden" name="store_id" value="<?php echo $store['store_id']; ?>" />
  					<div class="tabbable">
  						...
  						<div class="tab-content">
  							<div id="emailverification_settings" class="tab-pane fade in active"><?php require(DIR_APPLICATION.'view/template/catalog/emailverification/tab_settings.php') ?></div>
  						</div>						
  					</div>  					
  				</form>
  			</div>
