			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-instagram" class="form-horizontal">
					...
					<ul class="nav nav-tabs">
						<li class="active"><a href="#tab-instagram" data-toggle="tab" aria-expanded="true"><?php echo $heading_title; ?></a></li>
						<li class=""><a href="#tab-css" data-toggle="tab" aria-expanded="false"><?php echo $text_customize_css; ?></a></li>						
						<li class=""><a href="#tab-log" data-toggle="tab" aria-expanded="false"><?php echo $text_log; ?></a></li>
						<li class="support-me"><a href="#tab-support" data-toggle="tab" aria-expanded="false"><?php echo $text_support_me; ?></a></li>
					</ul>
					...
					<div class="tab-content">
						<div id="tab-instagram" class="tab-pane active">
							...
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tab-instagram-options" data-toggle="tab" aria-expanded="true"><?php echo $text_api_options; ?></a></li>
								<li class="hidden"><a href="#tab-instagram-advance" data-toggle="tab" aria-expanded="false"><?php echo $text_api_advanced_options; ?></a></li>
							</ul>
							<div class="tab-content">
								<div id="tab-instagram-options" class="tab-pane active">
									<div class="form-group required">
										...
										<div class="col-sm-10">
											...
											<?php } ?>
											<div><a href="http://instagram.pixelunion.net/" target="_blank"><?php echo $entry_text_generate_token; ?></a></div>
										</div>
									</div>
									...
									<div class="form-group heart-input <?php echo ($instagram_hover_heart) ? '' : 'hidden';?>">
										<label class="col-sm-2 control-label" for="heart_color"><?php echo $entry_heart_color; ?></label>
										<div class="col-sm-10">
											<div class="input-group">
												<input type="text" value="<?php echo $instagram_heart_color; ?>" placeholder="<?php echo $instagram_heart_color; ?>"  class="form-control color-heart" disabled />
												<input type="hidden" id="heart_color" name="instagram_heart_color" value="<?php echo $instagram_heart_color; ?>" class="color-heart">												
												<span class="input-group-addon"><span data-toggle="tooltip" title="<?php echo $help_instagram_heart_color; ?>"><input type='text' id="instagram_heart_color" /> </span></span>
											</div>
										</div>
									</div>

									<div class="form-group heart-input <?php echo ($instagram_hover_heart) ? '' : 'hidden';?>">
										<label class="col-sm-2 control-label" for="heart_text_color"><?php echo $entry_heart_text_color; ?></label>
										<div class="col-sm-10">
											<div class="input-group">
												<input type="text" value="<?php echo $instagram_text_heart_color; ?>" placeholder="<?php echo $instagram_text_heart_color; ?>"  class="form-control color-text-heart" disabled />
												<input type="hidden" id="heart_text_color" name="instagram_text_heart_color" value="<?php echo $instagram_text_heart_color; ?>" class="color-text-heart">												
												<span class="input-group-addon"><span data-toggle="tooltip" title="<?php echo $help_instagram_text_heart_color; ?>"><input type='text' id="instagram_text_heart_color" /> </span></span>
											</div>
										</div>
									</div>
								...
								<div id="tab-instagram-advance" class="tab-pane">
							...
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tab-slick-options" data-toggle="tab" aria-expanded="true"><?php echo $text_slick_options; ?></a></li>
								<li class="hidden"><a href="#tab-slick-advance" data-toggle="tab" aria-expanded="false"><?php echo $text_slick_advanced_options; ?></a></li>
							</ul>
							<div class="tab-content">
								<div id="tab-slick-options" class="tab-pane active">

									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-use-slick"><?php echo $entry_use_slick; ?></label>
										<div class="col-sm-10">
									...
									<div class="use-plugin <?php echo ($instagram_use_plugin) ? '' : 'hidden';?>">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-photo-show"><?php echo $entry_photo_show_tablet; ?></label>
											<div class="col-sm-10">
												<input type="text" name="instagram_plugin_slide_show_tablet" value="<?php echo $instagram_plugin_slide_show_tablet; ?>" placeholder="<?php echo $entry_photo_show_tablet; ?>" id="input-photo-show" class="form-control" />
												<?php if ($error_slide_show_tablet) { ?>
												<div class="text-danger"><?php echo $error_slide_show_tablet; ?></div>
												<?php } ?>
											</div>
										</div>

										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-plugin-slide-show"><?php echo $entry_slide_scroll_tablet; ?></label>
											<div class="col-sm-10">
												<input type="text" name="instagram_plugin_slide_scroll_tablet" value="<?php echo $instagram_plugin_slide_scroll_tablet; ?>" placeholder="<?php echo $entry_slide_scroll_tablet; ?>" id="input-plugin-slide-scroll" class="form-control" />
												<?php if ($error_slide_scroll_tablet) { ?>
												<div class="text-danger"><?php echo $error_slide_scroll_tablet; ?></div>
												<?php } ?>
											</div>
										</div>

										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-photo-show"><?php echo $entry_photo_show_celphone; ?></label>
											<div class="col-sm-10">
												<input type="text" name="instagram_plugin_slide_show_celphone" value="<?php echo $instagram_plugin_slide_show_celphone; ?>" placeholder="<?php echo $entry_photo_show_celphone; ?>" id="input-photo-show" class="form-control" />
												<?php if ($error_slide_show_celphone) { ?>
												<div class="text-danger"><?php echo $error_slide_show_celphone; ?></div>
												<?php } ?>
											</div>
										</div>

										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-plugin-slide-show"><?php echo $entry_slide_scroll_celphone; ?></label>
											<div class="col-sm-10">
												<input type="text" name="instagram_plugin_slide_scroll_celphone" value="<?php echo $instagram_plugin_slide_scroll_celphone; ?>" placeholder="<?php echo $entry_slide_scroll_celphone; ?>" id="input-plugin-slide-scroll" class="form-control" />
												<?php if ($error_slide_scroll_celphone) { ?>
												<div class="text-danger"><?php echo $error_slide_scroll_celphone; ?></div>
												<?php } ?>
											</div>
										</div>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-plugin-dots"><?php echo $entry_center_mode; ?></label>
											<div class="col-sm-10">
										...
										<div class="form-group color-input <?php echo ($instagram_plugin_arrows) ? '' : 'hidden';?>">
											...
											<div class="col-sm-10">
												<div class="input-group">
													...
													<?php } ?>
													<span class="input-group-addon"><span data-toggle="tooltip" title="<?php echo $help_instagram_arrow_color; ?>"><input type='text' id="heart_instagram_color" /> </span></span>
												</div>
											</div>
										</div>
								...
								<div id="tab-slick-advance" class="tab-pane">
						...
						<div id="tab-log" class="tab-pane">
							<div class="row">
								...
								<div class="col-md-10">
									<div class="panel-heading">
										<h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $text_log_tab; ?></h3>
									</div>
								</div>
							...
							<div class="panel-body">
								<textarea wrap="off" rows="15" readonly class="form-control"><?php echo $log_instagram; ?></textarea>
							</div>
						</div>
						...
						<div id="tab-css" class="tab-pane">
							<div class="panel-heading">
								<h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $text_customize_layout; ?></h3>
							</div>
						...
						<div id="tab-support" class="tab-pane">
							<div class="card text-center">
								...
								<div class="card-body">
									...
									<a href="mailto:hebert.dev@hotmail.com?subject=I need Support (<?php echo $version; ?>)" target="_blank" class="btn btn-info"><i class="fa fa-envelope"></i> Get Support</a>

								</div>
								<div class="card-footer text-muted">
									Version: Instagram Feed 2.2
								</div>
							</div>
						</div>					
					</div>
