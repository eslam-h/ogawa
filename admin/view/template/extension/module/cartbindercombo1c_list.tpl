  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
          ...
          <h3 class="panel-title offerlist"><i class="fa fa-list"></i> <?php echo $headerinfo; ?></h3>
           ...
           <div class="panel-body">
            ...
            <tr>
              ...
              <td class="text-center discountapply"><?php echo $text_discountapply; ?></td>
        ...
        <tbody>
          ...
          <?php if ($cartbindercombo1cs) { ?>
          <?php foreach ($cartbindercombo1cs as $cartbindercombo1c) { ?>
          <tr>
            <td style="text-align: center;">
              <input type="checkbox" name="selected[]" value="<?php echo $cartbindercombo1c['id']; ?>"/>
             </td>
            <td class="text-center"><h4><b><?php echo $cartbindercombo1c['name']; ?></b></h4></td>
            <td class="text-center"><?php echo html_entity_decode($cartbindercombo1c['primaryproducts']); ?></td>
            <td class="text-center"><?php echo html_entity_decode($cartbindercombo1c['optionnames']); ?></td>
            <td class="text-center"><?php echo $cartbindercombo1c['primaryquant']; ?></td>
            <td class="text-center"><?php echo $cartbindercombo1c['secondaryquant']; ?></td>
            <td class="text-center"><?php echo $cartbindercombo1c['type']; ?></td>
            <td class="text-center"><?php echo $cartbindercombo1c['discount']; ?></td>
            <td class="text-center"><?php echo $cartbindercombo1c['total']; ?></td>
            <td class="text-center"><?php echo $cartbindercombo1c['offersapplied']; ?></td>
            <td class="text-center"><?php echo $cartbindercombo1c['status']; ?></td>
            <td class="text-center"><?php foreach ($cartbindercombo1c['action'] as $action) { ?>
...
function filter() {
  url = 'index.php?route=module/cartbindercombo1c&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?route=module/cartbindercombo1c/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
      dataType: 'json',
