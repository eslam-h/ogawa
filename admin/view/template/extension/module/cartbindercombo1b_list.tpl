  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
        ...
        <tbody>
          ...
          <?php if ($cartbindercombo1bs) { ?>
          <?php foreach ($cartbindercombo1bs as $cartbindercombo1b) { ?>
          <tr>
            <td style="text-align: center;">
              <input type="checkbox" name="selected[]" value="<?php echo $cartbindercombo1b['id']; ?>"/>
             </td>
            <td class="text-center"><h4><b><?php echo $cartbindercombo1b['name']; ?></b></h4></td>
            <td class="text-center"><?php echo html_entity_decode($cartbindercombo1b['primaryproducts']); ?></td>
            <td class="text-center"><?php echo $cartbindercombo1b['type']; ?></td>
            <td class="text-center"><?php echo $cartbindercombo1b['discount']; ?></td>
            <td class="text-center"><?php echo html_entity_decode($cartbindercombo1b['secondarycategories']); ?></td>
            <td class="text-center"><?php echo $cartbindercombo1b['total']; ?></td>
            <td class="text-center"><?php echo $cartbindercombo1b['offersapplied']; ?></td>
            <td class="text-center"><?php echo $cartbindercombo1b['status']; ?></td>
            <td class="text-center"><?php foreach ($cartbindercombo1b['action'] as $action) { ?>
...
function filter() {
  url = 'index.php?route=module/cartbindercombo1b&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?route=module/cartbindercombo1b/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
      dataType: 'json',
