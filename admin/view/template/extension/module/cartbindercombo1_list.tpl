  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
        ...
        <tbody>
          ...
          <?php if ($cartbindercombo1s) { ?>
          <?php foreach ($cartbindercombo1s as $cartbindercombo1) { ?>
          <tr>
            <td style="text-align: center;">
              <input type="checkbox" name="selected[]" value="<?php echo $cartbindercombo1['id']; ?>"/>
             </td>
            <td class="text-center"><h4><b><?php echo $cartbindercombo1['name']; ?></b></h4></td>
            <td class="text-center"><?php echo html_entity_decode($cartbindercombo1['primaryproducts']); ?></td>
            <td class="text-center"><?php echo $cartbindercombo1['type']; ?></td>
            <td class="text-center"><?php echo $cartbindercombo1['discount']; ?></td>
            <td class="text-center"><?php echo html_entity_decode($cartbindercombo1['secondaryproducts']); ?></td>
            <td class="text-center"><?php echo $cartbindercombo1['total']; ?></td>
            <td class="text-center"><?php echo $cartbindercombo1['offersapplied']; ?></td>
            <td class="text-center"><?php echo $cartbindercombo1['status']; ?></td>
            <td class="text-center"><?php foreach ($cartbindercombo1['action'] as $action) { ?>
...
function filter() {
  url = 'index.php?route=module/cartbindercombo1&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?route=module/cartbindercombo1/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
      dataType: 'json',
