  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
          ...
          <h3 class="panel-title offerlist"><i class="fa fa-list"></i> <?php echo $headerinfo; ?></h3>
           ...
           <div class="panel-body">
            ...
            <tr>
              ...
              <td class="text-center secondarycats"><?php echo $text_secondarycats; ?></td>
        ...
        <tbody>
          ...
          <?php if ($cartbindercombo2s) { ?>
          <?php foreach ($cartbindercombo2s as $cartbindercombo2) { ?>
          <tr>
            ...
            <td class="text-center"><?php echo html_entity_decode($cartbindercombo2['secondarycategories']); ?></td>
            <td class="text-center"><?php echo html_entity_decode($cartbindercombo2['secondaryproducts']); ?></td>
...
function filter() {
  url = 'index.php?route=module/cartbindercombo2&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?route=module/cartbindercombo2/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
      dataType: 'json',
