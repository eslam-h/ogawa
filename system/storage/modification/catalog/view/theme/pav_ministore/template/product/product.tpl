      ...
      <div class="product-info">
       ...
       <?php if ($salescombopgeoffers) {  foreach($salescombopgeoffers as $offer) { echo html_entity_decode($offer['html']); } } ?>
          ...
          <ul class="list-unstyled">
              ...
              <?php } else { ?>
              <li><span class="check-box text-danger"><i class="zmdi zmdi-block zmdi-hc-fw"></i></span><?php echo $text_stock; ?><span class="check-box text-danger"><?php echo $stock; ?></span></li>
              <?php } ?>
