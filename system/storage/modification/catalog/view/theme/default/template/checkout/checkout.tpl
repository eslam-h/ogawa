      ...
      <div class="panel-group" id="accordion">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 style="font-size: 24px;" class="panel-title"><?php echo $text_checkout_option; ?></h4>
          </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 style="font-size: 24px;" class="panel-title"><?php echo $text_checkout_account; ?></h4>
          </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 style="font-size: 24px;" class="panel-title" ><?php echo ""; ?></h4>
          </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 style="font-size: 24px;" class="panel-title"><?php echo $text_checkout_shipping_method; ?></h4>
          </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 style="font-size: 24px;" class="panel-title"><?php echo $text_checkout_payment_method; ?></h4>
          </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 style="font-size: 24px;" class="panel-title"><?php echo $text_checkout_confirm; ?></h4>
          </div>
