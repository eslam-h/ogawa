  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row product-grid main-products">
        ...
        <div class="product-offer product-layout product-grid-item col-lg-3 col-md-3 col-sm-6 col-xs-12 product-grid-item xs-100 sm-50 md-33 lg-25 xl-25 display-icon inline-button">
          ...
          <div class="gift-thumb product-wrapper">
            ...
            <?php } ?>
              <div class="caption">
                <h4 class="name"><a href="<?php echo $offer['href']; ?>"><?php echo $offer['title']; ?></a></h4>
              </div>
